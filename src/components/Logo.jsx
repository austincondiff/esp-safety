...
const StyledSvg = styled.svg`
  ${({ light, width, height, transitionDuration, transitionDelay }) => `
    ${width && `width: ${width};`}
...
const Logo = ({...props}) => (
  <StyledSvg {...props} x="0px" y="0px" viewBox="0 0 285.5 64">
  	...
  	<path class="esp-text" fill="#000000" d="M133.7,31.6h3.4c2.4,0,3.6-1.6,3.6-3.9c0-2.3-1.2-3.8-3.5-3.8h-3.6V31.6z M126.7,46.4V17.8
  		...
  		V46.4z"/>
    <path class="safety-text" fill="#666666" d="M273.3,46.4h2.8V34.3l9.4-16h-3.1l-6,10.2c-0.9,1.5-1.7,3.4-1.7,3.4h-0.1c0,0-0.9-1.9-1.7-3.4
